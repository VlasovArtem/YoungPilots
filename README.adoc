...
* *Useful Things* - It is the most interesting content of the podcasts. Almost every broadcasting, creators is sharing with all listeners some mount of useful things, that can help programmers to increase performance of their code.
