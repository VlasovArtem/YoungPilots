 ...
 */
define(['./conferences-module.js'], function (conferenceDirectives) {
    'use strict';
    conferenceDirectives.directive('socials', function() {
        return {
            restrict: 'A',
            scope: {
                socials: '=',
    ...
    conferenceDirectives.directive('searchForm', function($filter) {
        return {
            restrict: 'E',
            replace: true,
