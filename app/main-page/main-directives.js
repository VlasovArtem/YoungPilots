...
define(['./main-module.js'], function (main) {
    'use strict';
    main.directive('broadcast', function($timeout, BroadcastLive, $route, Broadcast, $filter) {
        return {
            restrict: 'A',
    ...
    main.directive('countdown', function($timeout, $filter) {
        return {
            restrict: 'C',
            scope: {
                date: '=',
    ...
    main.directive('contacts', function() {
        return {
            restrict: 'E',
            require: '^ngModel',
            link: function(scope, element, attrs) {
